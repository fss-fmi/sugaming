    ...
    <Card className="max-w-[350px] transition hover:-translate-y-1 hover:shadow-lg cursor-pointer">
      ...
      <CardContent className="p-3">
        <div className="flex flex-row items-center">
          ...
          {/* <MdGroups className="w-6 h-6 mr-2" /> */}
