...
-- AddForeignKey
ALTER TABLE "cs2_team_invitations" ADD CONSTRAINT "cs2_team_invitations_cs2_team_id_fkey" FOREIGN KEY ("cs2_team_id") REFERENCES "Cs2Teams"("id") ON DELETE CASCADE ON UPDATE CASCADE;
